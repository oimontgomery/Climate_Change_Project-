...
d3.json("/csv_2", function(error, data) {
...
xText
  .append("text")
  .attr("y", -26)
  .attr("data-name", "Declaration_Year")
  .attr("data-axis", "x")
...
yText
  ...
  .append("text")
  .attr("x", 0)
  .attr("data-name", "Avg_Temp(Farenheit)")
  .attr("data-axis", "y")
  .attr("class", "aText inactive y")
  .text("Avg Temp (Farenheit)");
...
function visualize(theData) {
  ...
  var curX = "Declaration_Year";
  var curY = "Disaster_Count";
  ...
  var toolTip = d3
    ...
    .html(function(d) {
      ...
      var theX;
      // Grab the state name.
      var theDisaster = "<div>" + d.Disaster_Type + "</div>";
      // Snatch the y value's key and value.
      var theY = "<div>" + curY + ": " + d[curY];
      // If the x key is poverty
      if (curX === "Declaration_Year") {
